...
public:
     ...
     * @brief Constructor.
     */
	VLVector() : _size(0), _capacity(StaticCapacity), _heapArray(nullptr)
	{}
...
void VLVector<Type, StaticCapacity>::_updateHeap()
{
 ...
 */
template<class Type, size_t StaticCapacity>
void VLVector<Type, StaticCapacity>::_heapToStatic()
{
...
template<class Type, size_t StaticCapacity>
template<class InputIterator>
VLVector<Type, StaticCapacity>::VLVector(InputIterator first, const InputIterator last):VLVector()
{
	while (first != last)
	{
		push_back(*first);
 ...
 */
template<class Type, size_t StaticCapacity>
VLVector<Type, StaticCapacity> &VLVector<Type, StaticCapacity>::operator=(const VLVector &other)
{
	if (this == &other)
	{
		return *this;
 ...
 */
template<class Type, size_t StaticCapacity>
VLVector<Type, StaticCapacity>::~VLVector()
{
	if (_heapArray != nullptr)
	{
		delete[] _heapArray;
 ...
 */
template<class Type, size_t StaticCapacity>
Type &VLVector<Type, StaticCapacity>::at(const size_t index) noexcept(false)
{
	if (index >= _size)
	{
 ...
 */
template<class Type, size_t StaticCapacity>
const Type &VLVector<Type, StaticCapacity>::at(const size_t index) const noexcept(false)
{
	if (index >= _size)
	{
		throw std::out_of_range("index is out of range");
 ...
 */
template<class Type, size_t StaticCapacity>
void VLVector<Type, StaticCapacity>::push_back(const Type &element)
{
	_size++;
	if (_size > capacity())
	{
 ...
 */
template<class Type, size_t StaticCapacity>
typename VLVector<Type, StaticCapacity>::iterator
VLVector<Type, StaticCapacity>::insert(VLVector::iterator position, const Type &element)
{
...
template<class Type, size_t StaticCapacity>
typename VLVector<Type, StaticCapacity>::iterator
VLVector<Type, StaticCapacity>::insert(VLVector::const_iterator position, const Type &element)
{
...
template<class InputIterator>
typename VLVector<Type, StaticCapacity>::iterator
VLVector<Type, StaticCapacity>::insert(VLVector::iterator position, InputIterator first,
									   const InputIterator last)
{
	size_t positionIndex = position - begin();
...
template<class InputIterator>
typename VLVector<Type, StaticCapacity>::iterator
VLVector<Type, StaticCapacity>::insert(VLVector::const_iterator position,
 ...
 */
template<class Type, size_t StaticCapacity>
void VLVector<Type, StaticCapacity>::pop_back()
{
	_size--;
...
template<class Type, size_t StaticCapacity>
typename VLVector<Type, StaticCapacity>::iterator
VLVector<Type, StaticCapacity>::erase(VLVector::iterator position)
{
...
template<class Type, size_t StaticCapacity>
typename VLVector<Type, StaticCapacity>::iterator
VLVector<Type, StaticCapacity>::erase(VLVector::const_iterator position)
{
...
template<class Type, size_t StaticCapacity>
typename VLVector<Type, StaticCapacity>::iterator
VLVector<Type, StaticCapacity>::erase(VLVector::iterator first, VLVector::iterator last)
{
...
template<class Type, size_t StaticCapacity>
typename VLVector<Type, StaticCapacity>::iterator
VLVector<Type, StaticCapacity>::erase(VLVector::const_iterator first,
									  VLVector::const_iterator last)
{
 ...
 */
template<class Type, size_t StaticCapacity>
void VLVector<Type, StaticCapacity>::clear()
{
	_size = 0;
	_capacity = StaticCapacity;
	if (_heapArray != nullptr)
 ...
 */
template<class Type, size_t StaticCapacity>
Type *VLVector<Type, StaticCapacity>::data() noexcept
{
	if (_heapArray != nullptr)
	{
		return _heapArray;
 ...
 */
template<class Type, size_t StaticCapacity>
const Type *VLVector<Type, StaticCapacity>::data() const noexcept
{
	if (_heapArray != nullptr)
	{
		return _heapArray;
 ...
 */
template<class Type, size_t StaticCapacity>
Type &VLVector<Type, StaticCapacity>::operator[](const size_t position)
{
 ...
 */
template<class Type, size_t StaticCapacity>
const Type &VLVector<Type, StaticCapacity>::operator[](const size_t position) const
{
	return data()[position];
}
 ...
 */
template<class Type, size_t StaticCapacity>
bool operator==(const VLVector<Type, StaticCapacity> &lhs,
				const VLVector<Type, StaticCapacity> &rhs)
{
